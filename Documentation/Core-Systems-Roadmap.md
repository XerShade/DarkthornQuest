...
- [x] Create GameState enum (Menu, Playing, Paused, GameOver)
- [x] Implement StateManager service to handle state transitions
- [ ] Add state change events for systems to react to
- [x] Wire state manager into GameLifecycle injector pattern
